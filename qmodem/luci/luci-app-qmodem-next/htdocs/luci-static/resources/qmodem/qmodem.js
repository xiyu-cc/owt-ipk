...
return L.Class.extend({
	...
	getNeighborCell: function(section, params) {
		var hadTimeout = Object.prototype.hasOwnProperty.call(L.env, 'rpctimeout');
		var oldTimeout = L.env.rpctimeout;
		var rpcTimeout = 200;
		if (params && Object.prototype.hasOwnProperty.call(params, 'timeout')) {
			var value = parseInt(params.timeout, 10);
			if (!isNaN(value) && value > 0)
				rpcTimeout = Math.max(200, value + 30);
		}
		L.env.rpctimeout = rpcTimeout;
		return callGetNeighborcell(section, params || {}).then(function(res) {
			if (hadTimeout)
